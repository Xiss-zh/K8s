...
```shell
# 配置主机名
hostnamectl set-hostname k8s-temp
...
![image-20230426105619442](D:\GitHub\K8s\png\image-20230426105619442.png)
...
# 将空闲磁盘扩容到根目录
vgdisplay
lvextend -l +384 /dev/cl/root
xfs_growfs /dev/cl/root
```

![image-20230426105901299](D:\GitHub\K8s\png\image-20230426105901299.png)

![image-20230426114337114](D:\GitHub\K8s\png\image-20230426114337114.png)
...
![image-20230426112515838](D:\GitHub\K8s\png\image-20230426112515838.png)

![image-20230426112737311](D:\GitHub\K8s\png\image-20230426112737311.png)
...
localAPIEndpoint:
  advertiseAddress: 192.168.10.201   # ip地址
  bindPort: 6443
nodeRegistration:
  criSocket: unix:///var/run/containerd/containerd.sock
  imagePullPolicy: IfNotPresent
  name: k8s-master01   #设置主机名
  taints: null
---
apiServer:
...
![image-20230426143913785](D:\GitHub\K8s\png\image-20230426143913785.png)
